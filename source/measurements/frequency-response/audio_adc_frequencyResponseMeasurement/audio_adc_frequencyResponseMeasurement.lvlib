...
<Library LVVersion="21008000">
	...
	<Item Name="SubVIs" Type="Folder">
		<Item Name="Calculate Amplitude at Target Frequency.vi" Type="VI" URL="../sub-vis/Calculate Amplitude at Target Frequency.vi"/>
		<Item Name="Calculate Frequency Response.vi" Type="VI" URL="../sub-vis/Calculate Frequency Response.vi"/>
		<Item Name="Calculate Measurement Parameters.vi" Type="VI" URL="../sub-vis/Calculate Measurement Parameters.vi"/>
		<Item Name="Create and Configure AO.vi" Type="VI" URL="../sub-vis/Create and Configure AO.vi"/>
		<Item Name="Create and Configure Signal Configuration.vi" Type="VI" URL="../sub-vis/Create and Configure Signal Configuration.vi"/>
	</Item>
